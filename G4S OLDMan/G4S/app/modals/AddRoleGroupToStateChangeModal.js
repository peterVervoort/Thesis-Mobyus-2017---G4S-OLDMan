(function () {
    ...
    angular
        .module('app')
        .controller('AddRoleGroupToStateChangeModal', ['$uibModalInstance', 'UserRoleGroupService', 'toaster', 'NetworkService', 'Resources', 'States', 'param', AddRoleGroupModal]);
    ...
    function AddRoleGroupModal($uibModalInstance, userRoleGroupService, toaster, network, resources, states, param) {
        ...
        ctrl.save = function (isValid) {
            if (ctrl.userRoleGroup) {
                ctrl.loading = true;
                userRoleGroupService.addGroupToStateChange(ctrl.change.id, ctrl.userRoleGroup).then(function (response) {
