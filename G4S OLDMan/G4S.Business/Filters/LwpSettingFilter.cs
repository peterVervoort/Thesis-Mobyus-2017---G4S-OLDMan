...
{
    internal class LwpSettingFilter : EntityFilterBase<LwpSetting>, IEntityFilter<LwpSetting>
    {
        public override Task<IQueryable<LwpSetting>> FilterAsync(IQueryable<LwpSetting> query, SearchBase<LwpSetting> searchCriteria)
        {
            if (searchCriteria.GetType().Equals(typeof(LwpSettingSearchCriteria)))
            {

                LwpSettingSearchCriteria criteria = (LwpSettingSearchCriteria)searchCriteria;
        ...
        public override IQueryable<LwpSetting> Order(IQueryable<LwpSetting> query, SearchBase<LwpSetting> searchCriteria)
        {
